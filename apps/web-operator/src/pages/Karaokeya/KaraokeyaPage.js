...
import { ArrowLeft, Mic2, Clock, Phone, Users, CheckCircle, XCircle, RefreshCw, Search, Wifi, WifiOff, Settings, ExternalLink, UserX, GripVertical } from 'lucide-react';
import { clsx } from 'clsx';
import { eventsApi, karaokeyaApi } from '@/lib/api';
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Config link */}
          <Link to={`/events/${eventId}/karaokeya/config`} className="p-2 hover:bg-gray-100 rounded-lg transition-colors" title="Configuración">
      ...
      {/* Stats cards */}
      {stats && (<div className="grid grid-cols-2 md:grid-cols-7 gap-4">
      ...
      {config && event && (<DisplayControlPanel eventId={eventId} eventSlug={event.slug} config={{
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-4">
        ...
        <div className="relative flex-1 max-w-sm">
          ...
          <input type="text" placeholder="Buscar canción o solicitante..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"/>
        </div>
      </div>
      ...
      <div className="p-4">
        <div className="flex items-start gap-4">
          ...
          <div className="w-16 h-16 rounded-lg bg-gray-200 overflow-hidden flex-shrink-0">
            {request.song?.thumbnailUrl ? (<img src={request.song.thumbnailUrl} alt={request.title} className="w-full h-full object-cover"/>) : (<div className="w-full h-full flex items-center justify-center">
          ...
          <div className="flex-1 min-w-0">
            ...
            {request.artist && (<p className="text-gray-600 truncate">{request.artist}</p>)}
        ...
        <div className="flex items-center gap-2 mt-4 pt-4 border-t border-gray-100">
          ...
          {/* YouTube link */}
          {request.song?.youtubeShareUrl && (<a href={request.song.youtubeShareUrl} target="_blank" rel="noopener noreferrer" className="ml-auto flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium text-red-600 hover:bg-red-50 transition-colors">
...
//# sourceMappingURL=KaraokeyaPage.js.map