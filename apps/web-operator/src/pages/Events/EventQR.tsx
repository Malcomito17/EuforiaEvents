      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        ...
        <div className="mb-6">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 border border-gray-300 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors flex items-center gap-2"
            >
              {copied ? (
                <>
        ...
        <div className="flex justify-center gap-4">
          <button
            ...
            className="px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-lg flex items-center gap-2 transition-colors"
          >
