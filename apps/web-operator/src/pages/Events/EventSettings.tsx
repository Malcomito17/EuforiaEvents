...
export function EventSettingsPage() {
  ...
  const [musicadjConfig, setMusicadjConfig] = useState<MusicadjConfig>({
    enabled: false,
    cooldownSeconds: 300,
    maxPerUser: 5,
    welcomeMessage: null,
  ...
  const [karaokeyaConfig, setKaraokeyaConfig] = useState<KaraokeyaConfig>({
    enabled: false,
    cooldownSeconds: 300,
    maxPerPerson: 3,
    welcomeMessage: null,
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          disabled={saving}
          className={clsx(
            'inline-flex items-center gap-2 px-6 py-2 rounded-lg font-semibold transition-colors',
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-start gap-4 mb-6">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
                checked={musicadjConfig.enabled}
                onChange={(e) =>
                  setMusicadjConfig({ ...musicadjConfig, enabled: e.target.checked })
                }
          ...
          {musicadjConfig.enabled && (
            <div className="space-y-4 pt-4 border-t border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    min="0"
                    max="3600"
                    value={musicadjConfig.cooldownSeconds}
                    onChange={(e) =>
                      setMusicadjConfig({
                        ...musicadjConfig,
                ...
                <div>
                  ...
                  <input
                    ...
                    min="1"
                    max="20"
                    value={musicadjConfig.maxPerUser}
                    onChange={(e) =>
                      setMusicadjConfig({
                        ...musicadjConfig,
              ...
              <div>
                ...
                <textarea
                  value={musicadjConfig.welcomeMessage || ''}
                  onChange={(e) =>
                    setMusicadjConfig({
                      ...musicadjConfig,
                  ...
                  rows={3}
                  placeholder="Ej: ¡Bienvenido! Pedí tu tema favorito para la fiesta..."
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:outline-none"
                />
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-start gap-4 mb-6">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
                checked={karaokeyaConfig.enabled}
                onChange={(e) =>
                  setKaraokeyaConfig({ ...karaokeyaConfig, enabled: e.target.checked })
                }
                className="sr-only peer"
              />
          ...
          {karaokeyaConfig.enabled && (
            <div className="space-y-4 pt-4 border-t border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    min="0"
                    max="3600"
                    value={karaokeyaConfig.cooldownSeconds}
                    onChange={(e) =>
                      setKaraokeyaConfig({
                        ...karaokeyaConfig,
                        cooldownSeconds: parseInt(e.target.value) || 0,
                ...
                <div>
                  ...
                  <input
                    ...
                    min="1"
                    max="10"
                    value={karaokeyaConfig.maxPerPerson}
                    onChange={(e) =>
                      setKaraokeyaConfig({
                        ...karaokeyaConfig,
              ...
              <div>
                ...
                <textarea
                  value={karaokeyaConfig.welcomeMessage || ''}
                  onChange={(e) =>
                    setKaraokeyaConfig({
                      ...karaokeyaConfig,
                      welcomeMessage: e.target.value || null,
                  ...
                  rows={3}
                  placeholder="Ej: ¡Animate a cantar! Buscá tu tema favorito..."
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:outline-none"
                />
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-purple-50 rounded-lg border border-purple-200">
                ...
                <label className="relative inline-flex items-center cursor-pointer ml-4">
                  <input
                    type="checkbox"
                    checked={karaokeyaConfig.suggestionsEnabled}
                    onChange={(e) =>
                      setKaraokeyaConfig({
                        ...karaokeyaConfig,
