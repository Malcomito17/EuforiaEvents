...
export default function RequestSuccess() {
    ...
    return (<div className="min-h-screen pb-safe">
      ...
      <div className="w-full max-w-xs space-y-3">
        <button onClick={() => navigate(`/e/${slug}/musicadj/mis-pedidos`)} className="btn-primary w-full flex items-center justify-center gap-2">
          <ListMusic className="w-5 h-5"/>
          Ver mis pedidos
        </button>

        <button onClick={() => navigate(`/e/${slug}/musicadj`)} className="btn-secondary w-full flex items-center justify-center gap-2">
          <Plus className="w-5 h-5"/>
          Pedir otro tema
        </button>

        <button onClick={() => navigate(`/e/${slug}`)} className="btn-secondary w-full flex items-center justify-center gap-2">
