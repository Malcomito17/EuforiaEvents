...
export default function EventLanding() {
        ...
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-8">
            ...
            <div className="card border-2 border-white/10">
              {event.status === 'DRAFT' && (<div className="space-y-3">
              ...
              {event.status === 'PAUSED' && (<div className="space-y-3">
              ...
              {event.status === 'FINISHED' && (<div className="space-y-3">
          ...
          {event.eventData && (<div className="card bg-white/5 border border-white/10">
              <div className="space-y-2 text-sm">
                {event.venue && (<div className="flex items-center gap-2 text-white/60">
                    <div className="w-1.5 h-1.5 bg-primary-500 rounded-full"></div>
                    <span>{event.venue.name}</span>
                  </div>)}
                {event.startDate && (<div className="flex items-center gap-2 text-white/60">
                    <div className="w-1.5 h-1.5 bg-primary-500 rounded-full"></div>
    ...
    return (<div className="min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="text-center mb-8">
        ...
        {musicadjConfig?.welcomeMessage && (<p className="text-white/70 text-lg">{musicadjConfig.welcomeMessage}</p>)}

        {/* Botón de cambio de usuario */}
        {guest && (<button onClick={() => clearGuest()} className="mt-3 text-sm text-white/50 hover:text-white/80 transition-colors underline">
      ...
      <div className="w-full max-w-sm space-y-6">
        {/* MUSICADJ Section */}
        {musicadjConfig?.enabled && (<div className="bg-gradient-to-br from-primary-600/20 to-primary-800/20 rounded-2xl p-4 backdrop-blur-sm border border-primary-400/30">
            ...
            <div className="space-y-2">
              <button onClick={() => navigate(`/e/${slug}/musicadj`)} className="w-full card hover:bg-white/20 transition-all flex items-center gap-4 text-left">
              ...
              {guest && (<button onClick={() => navigate(`/e/${slug}/musicadj/mis-pedidos`)} className="w-full card hover:bg-white/20 transition-all flex items-center gap-4 text-left">
        ...
        {/* KARAOKEYA Section */}
        {karaokeyaConfig?.enabled && (<div className="bg-gradient-to-br from-purple-600/20 to-purple-800/20 rounded-2xl p-4 backdrop-blur-sm border border-purple-400/30">
            <div className="flex items-center gap-2 mb-3">
            ...
            <div className="space-y-2">
              <button onClick={() => navigate(`/e/${slug}/karaokeya`)} className="w-full card hover:bg-white/20 transition-all flex items-center gap-4 text-left">
              ...
              {guest && (<button onClick={() => navigate(`/e/${slug}/karaokeya/mi-cola`)} className="w-full card hover:bg-white/20 transition-all flex items-center gap-4 text-left">
...
//# sourceMappingURL=EventLanding.js.map