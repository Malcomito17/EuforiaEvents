...
export function useKaraokeNotifications() {
    ...
    const showNotification = async (options) => {
        const { title, body, icon = '/logo.png', playSound = true, vibrate = true } = options;
     ...
     */
    const notifyYourTurn = async (songTitle, artist) => {
...
//# sourceMappingURL=useKaraokeNotifications.js.map